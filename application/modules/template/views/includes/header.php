        ...
        <ul class="nav navbar-nav">
            <!-- Messages -->
             ...
             <li class="dropdown notifications-menu">
                    <a href="<?php echo base_url("stockmovment/stockmovment/index") ?>" >
                       <i class="fa fa-exclamation-triangle"></i>
                        <span class="label label-warning"><?php echo (!empty($smove->tm)?$smove->tm:0) ?>
                        </span>
                    </a>
                </li>
                 <li class="dropdown notifications-menu">
                    <a href="<?php echo base_url("stockmovment/stockmovment/index") ?>" >
                        ...
                        <span class="label label-warning">
                            <?php echo (!empty($isumove->tm)?$isumove->tm:0) ?>
                        </span>
                    </a>
                </li>
